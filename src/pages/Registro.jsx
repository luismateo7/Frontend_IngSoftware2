...
export default function Registro() {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            if (username) {
                const { data } = await axios.post(`https://backend-ing-software-2-juv5yvm2l-luismateo7.vercel.app/api/usuarios/registro`, { email, password, nombre, apellido, username })
                ...
                await axios.post(`https://backend-ing-software-2-juv5yvm2l-luismateo7.vercel.app/api/usuarios/registro`, { email, password, nombre, apellido })
